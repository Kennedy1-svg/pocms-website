...
const Footer = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto grid gap-8 md:grid-cols-3 text-center md:text-left">
        <div>
          <h4 className="text-lg font-bold text-blue-700 mb-2">Point of Care Lab</h4>
          <p className="text-gray-600 text-sm">
            Reliable diagnostic services with a focus on patient care and quick turnaround.
          </p>
        </div>
        <div>
          <h5 className="text-md font-semibold text-gray-700 mb-2">Quick Links</h5>
        ...
        <div>
          <h5 className="text-md font-semibold text-gray-700 mb-2">Contact</h5>
          <p className="text-gray-600 text-sm">
            Email: info@pointofcarelab.com<br />
