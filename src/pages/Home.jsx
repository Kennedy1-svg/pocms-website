...
export default function Home() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-50 to-teal-100 py-16 px-4 text-center lg:text-left">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/book"
                className="bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3 px-6 rounded-lg"
              >
                Book Appointment
              </Link>
              <Link
                to="/services"
                className="border border-blue-700 text-blue-700 hover:bg-blue-50 font-semibold py-3 px-6 rounded-lg"
              >
                View Services
              </Link>
            </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white shadow-md p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-blue-700 mb-2">Certified Professionals</h3>
            ...
            <div className="bg-white shadow-md p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-blue-700 mb-2">Secure Online Access</h3>
      ...
      {/* Call to Action */}
      <section className="py-12 px-4 text-center bg-blue-700 text-white">
        ...
        <Link
          to="/book"
          className="bg-white text-blue-700 font-semibold py-3 px-6 rounded-lg hover:bg-blue-50"
        >
          Book Now
        </Link>
      </section>
